...
public class ShowUserFragment extends Fragment {
    ...
    public class MyListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View viewitem = View.inflate(context, R.layout.list_item_user, null);

            llItem = (LinearLayout) viewitem.findViewById(R.id.ll_item);

            tvID = (TextView) viewitem.findViewById(R.id.tv_id);
            tvUno = (TextView) viewitem.findViewById(R.id.tv_uno);
            tvUname = (TextView) viewitem.findViewById(R.id.tv_uname);
            tvUclass = (TextView) viewitem.findViewById(R.id.tv_uclass);
            tvUper = (TextView) viewitem.findViewById(R.id.tv_uper);
            tvUcredit = (TextView) viewitem.findViewById(R.id.tv_ucredit);
