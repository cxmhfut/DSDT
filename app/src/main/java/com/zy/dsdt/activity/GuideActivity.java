...
import com.zy.dsdt.fragment.GuideItemFragment;
...
public class GuideActivity extends AppCompatActivity {
    ...
    private void endTutorial(){
        startActivity(new Intent(this, Main2UserActivity.class));
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            GuideItemFragment gf = null;
            switch(position){
                case 0:
                    gf = GuideItemFragment.newInstance(R.layout.welcome_fragment01);
                    break;
                case 1:
                    gf = GuideItemFragment.newInstance(R.layout.welcome_fragment02);
                    break;
                case 2:
                    gf = GuideItemFragment.newInstance(R.layout.welcome_fragment03);
                    break;
                case 3:
                    gf = GuideItemFragment.newInstance(R.layout.welcome_fragment5);
                    break;
            }
