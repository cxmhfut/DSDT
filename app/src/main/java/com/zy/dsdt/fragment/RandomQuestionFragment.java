...
public class RandomQuestionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_random_question, container, false);

        main = (Main2UserActivity) getActivity();
        llStart = (LinearLayout) view.findViewById(R.id.ll_random_question_start);

        llStart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                main.goToQuestionActivity(10);
            }
        });
